        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="action/usuario/insert.php" method="POST">
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="login" class="form-control" placeholder="Informe o Login de Usuario">
                  </div>
                  <div class="form-group">
                    <label for="login">Senha: </label>
                    <input type="password" name="senha" class="form-control" placeholder="Informe a Senha de Usuario">
                  </div>
